...
const stripe = new Stripe(
  "sk_test_51Px4RBL5rgTXjYqM19xah1EZqv4blrDzOGz8yUzVK0l4w44R53DQc5bSa06Mkmoy50z8iIj5dGb1CnNfxsWZ8jSz00OpAI1KUd"
);
// const stript=new Stripe(process.env.STRIPE_SECRET_KEY)

//placing user order from frot end
const placeOrder = async (req, res) => {
  ...
  try {
    ...
    await newOrder.save();
    await userMdel.findByIdAndUpdate(req.body.userId, { cartData: {} });
